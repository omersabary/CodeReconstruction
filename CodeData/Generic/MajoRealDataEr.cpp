...
int main()
{
    ...
    for(d_prob = 0.01 ; d_prob<=0.01; d_prob+=0.01){
        ...
        //while(nt<num_of_test){
            ...
            output_file.open("output-results.txt");
            ...
            while(!strands_file.eof()){
                ...
                getline(strands_file, line);
                /*if(ct==4490||ct==4756||ct==4850||ct==4879||ct==4896||ct==4929||
                        ct==4937|| ct==4940 || ct==4950|| ct==4955
                        || ct== 4969 || ct== 4971|| ct==4973|| ct == 4977
                        || ct == 4978 || ct == 4979 || ct == 4981
                        || ct == 4983 || ct == 4985 || ct == 4986
                        || ct == 4987){
                    ct++;
                    cout << "skip " << ct << endl;
                   continue;
                ...
                string karin = LOOKAhead_Majority(cluster, orig_length, 2);
                string karin_rev = LOOKAhead_Majority(reverse_cluster, orig_length, 2);
                //reverseStr(karin_rev);
                string nkarin="";
                for(int k=0; k<orig_length; k++){
                    if(k<orig_length/2)
                        nkarin.insert(nkarin.begin(), karin_rev[k]);
                }
                for(int k=orig_length/2-1; k>=0; k--){
                ...
                string karin_w3 = LOOKAhead_Majority(cluster, orig_length, 3);
                string karin_rev_w3 = LOOKAhead_Majority(reverse_cluster, orig_length, 3);
                //reverseStr(karin_rev);
                string nkarin_w3="";
                for(int k=0; k<orig_length; k++){
                    if(k<orig_length/2)
                ...
                string karin_w4 = LOOKAhead_Majority(cluster, orig_length, 4);
                string karin_rev_w4 = LOOKAhead_Majority(reverse_cluster, orig_length, 4);
                //reverseStr(karin_rev);
                string nkarin_w4="";
                for(int k=0; k<orig_length; k++){
                    if(k<orig_length/2)
                ...
                string matika = makeMajorityEditDistance(cluster, orig_length);
                string matika_rev =makeMajorityEditDistance(reverse_cluster, orig_length);
                ...
                matika = nmatika;
                output_file << nmatika << endl << endl << endl;

                string lookback =LOOKBack_Majority(cluster, orig_length);
                string lookback_rev =LOOKBack_Majority(reverse_cluster, orig_length);
                string nlookback="";
                for(int k=0; k<orig_length; k++){
                    if(k<orig_length/2)
